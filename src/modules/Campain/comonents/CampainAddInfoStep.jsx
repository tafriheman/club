...
class CampainAddInfoStep extends Component {
        ...
        <Grid item container md={6} sm={10} xs={12}  direction="column">
          <Grid item container>
            ...
            <TextField 
              ...
              value={name}
              style={{ width: '100%' }}
              onChange={e => campainCampainAddChangeProp('name', e.target.value)}
            />
          </Grid>
        ...
        <Grid item container md={6} sm={10} xs={12} direction="column">
          <Grid item container>
            ...
            <TextField 
              ...
              multiline
              rows={6}
              onChange={e => campainCampainAddChangeProp('description', e.target.value )}
            />
          </Grid>
        </Grid>
