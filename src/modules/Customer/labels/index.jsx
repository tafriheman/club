...
class LabelList extends Component {
  ...
  handleSubmitDialog = () => {
    this.props.DeleteLabelCutomer(
      this.state.selectedItem._id,
      this.props.club._id,
      this.props.match.params.customerId,
      this.props.token,
    ).then(()=>{
      const { token, club, getCustomerLabels } = this.props;
      getCustomerLabels(club._id, this.props.match.params.customerId, token).then((response) => {
        this.setState({
