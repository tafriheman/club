    ...
    return (
      ...
      >
        <Grid
          ...
          alignItems="center"
        >
          <Grid md={3} item className={classes.formContainer}>
            <Avatar
              src={require("../../assets/images/global/logo.jpg")}
              classes={{ root: classes.logo }}
            />
            <FormControl fullWidth className={classes.usernameFormControl}>
              <Input
                classes={{
                  input: classes.input,
            ...
            <p className={classes.policy}>
              تفریح من به شما این امکان را می دهد که برای خود یک باشگاه مشتریان
              ایجاد و مشتریان خود را مدیریت کنید و آن ها را به خرید مجدد ترغیب
              نمایید. جهت استفاده از این باشگاه، مشتریان ابتدا ثبت نام نمایید و
              افزونه مورد نظر خود را تهیه فرمایید.
            </p>
          </Grid>
        </Grid>
