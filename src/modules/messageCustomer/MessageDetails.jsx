        ...
        this.state.loading ? <CircularProgress className={classes.progress} /> :
         <Grid container spacing={16}>
                ...
                <Grid item xs={12} lg={6} xl={6} md={6} sm={6} spacing={16} className={classes.column}>
                    <Typography variant=""> متن پیام: </Typography>
                {
                ...
                <Grid item xs={12} lg={12} xl={12} md={12} sm={12} spacing={16}>
                 <Typography variant=""> {` فرستنده: ${this.state.messageDetails.sender_name}`} </Typography>
                  <Typography variant="">{`تاریخ ارسال : ${this.georgianToPersianDate(this.state.messageDetails.created_at_time)}`}</Typography>
                </Grid>
          </Grid>
      }
